...
public class FeeAppliedTaxObject {
  ...
  public FeeAppliedTaxObject lagoFeeId(@javax.annotation.Nullable UUID lagoFeeId) {
  ...
  public FeeAppliedTaxObject lagoId(@javax.annotation.Nullable UUID lagoId) {
  ...
  public FeeAppliedTaxObject lagoTaxId(@javax.annotation.Nullable UUID lagoTaxId) {
  ...
  public FeeAppliedTaxObject taxName(@javax.annotation.Nullable String taxName) {
  ...
  public FeeAppliedTaxObject taxCode(@javax.annotation.Nullable String taxCode) {
  ...
  public FeeAppliedTaxObject taxRate(@javax.annotation.Nullable BigDecimal taxRate) {
  ...
  public FeeAppliedTaxObject taxDescription(@javax.annotation.Nullable String taxDescription) {
  ...
  public FeeAppliedTaxObject amountCents(@javax.annotation.Nullable Integer amountCents) {
  ...
  public FeeAppliedTaxObject amountCurrency(@javax.annotation.Nullable Currency amountCurrency) {
  ...
  public FeeAppliedTaxObject createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {

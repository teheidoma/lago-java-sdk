...
public class OrganizationUpdateInput {
  ...
  public OrganizationUpdateInput organization(@javax.annotation.Nonnull OrganizationUpdateInputOrganization organization) {
  ...
  @JsonProperty(JSON_PROPERTY_ORGANIZATION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOrganization(@javax.annotation.Nonnull OrganizationUpdateInputOrganization organization) {
    this.organization = organization;
  }

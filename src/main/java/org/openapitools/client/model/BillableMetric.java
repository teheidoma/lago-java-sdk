...
public class BillableMetric {
  ...
  public BillableMetric billableMetric(@javax.annotation.Nonnull BillableMetricObject billableMetric) {
  ...
  @JsonProperty(JSON_PROPERTY_BILLABLE_METRIC)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setBillableMetric(@javax.annotation.Nonnull BillableMetricObject billableMetric) {
    this.billableMetric = billableMetric;
  }

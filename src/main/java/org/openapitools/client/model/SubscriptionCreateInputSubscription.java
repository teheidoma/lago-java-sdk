...
public class SubscriptionCreateInputSubscription {
  ...
  public SubscriptionCreateInputSubscription externalCustomerId(@javax.annotation.Nonnull String externalCustomerId) {
  ...
  public SubscriptionCreateInputSubscription planCode(@javax.annotation.Nonnull String planCode) {
  ...
  public SubscriptionCreateInputSubscription name(@javax.annotation.Nullable String name) {
  ...
  public SubscriptionCreateInputSubscription externalId(@javax.annotation.Nonnull String externalId) {
  ...
  public SubscriptionCreateInputSubscription billingTime(@javax.annotation.Nullable BillingTimeEnum billingTime) {
  ...
  public SubscriptionCreateInputSubscription endingAt(@javax.annotation.Nullable OffsetDateTime endingAt) {
  ...
  public SubscriptionCreateInputSubscription subscriptionAt(@javax.annotation.Nullable OffsetDateTime subscriptionAt) {
  ...
  public SubscriptionCreateInputSubscription planOverrides(@javax.annotation.Nullable PlanOverridesObject planOverrides) {
  ...
  @JsonProperty(JSON_PROPERTY_PLAN_OVERRIDES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPlanOverrides(@javax.annotation.Nullable PlanOverridesObject planOverrides) {
    this.planOverrides = planOverrides;
  }

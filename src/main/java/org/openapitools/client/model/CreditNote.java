...
public class CreditNote {
  ...
  public CreditNote creditNote(@javax.annotation.Nonnull CreditNoteObject creditNote) {
  ...
  @JsonProperty(JSON_PROPERTY_CREDIT_NOTE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreditNote(@javax.annotation.Nonnull CreditNoteObject creditNote) {
    this.creditNote = creditNote;
  }

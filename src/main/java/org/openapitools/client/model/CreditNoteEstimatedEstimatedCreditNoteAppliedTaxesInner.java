...
public class CreditNoteEstimatedEstimatedCreditNoteAppliedTaxesInner {
  ...
  public CreditNoteEstimatedEstimatedCreditNoteAppliedTaxesInner lagoTaxId(@javax.annotation.Nullable UUID lagoTaxId) {
  ...
  public CreditNoteEstimatedEstimatedCreditNoteAppliedTaxesInner taxName(@javax.annotation.Nullable String taxName) {
  ...
  public CreditNoteEstimatedEstimatedCreditNoteAppliedTaxesInner taxCode(@javax.annotation.Nullable String taxCode) {
  ...
  public CreditNoteEstimatedEstimatedCreditNoteAppliedTaxesInner taxRate(@javax.annotation.Nullable BigDecimal taxRate) {
  ...
  public CreditNoteEstimatedEstimatedCreditNoteAppliedTaxesInner taxDescription(@javax.annotation.Nullable String taxDescription) {
  ...
  public CreditNoteEstimatedEstimatedCreditNoteAppliedTaxesInner baseAmountCents(@javax.annotation.Nullable Integer baseAmountCents) {
  ...
  public CreditNoteEstimatedEstimatedCreditNoteAppliedTaxesInner amountCents(@javax.annotation.Nullable Integer amountCents) {
  ...
  public CreditNoteEstimatedEstimatedCreditNoteAppliedTaxesInner amountCurrency(@javax.annotation.Nullable Currency amountCurrency) {

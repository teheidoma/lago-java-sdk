...
public class InvoiceOneOffCreateInputInvoice {
  ...
  public InvoiceOneOffCreateInputInvoice externalCustomerId(@javax.annotation.Nonnull String externalCustomerId) {
  ...
  public InvoiceOneOffCreateInputInvoice currency(@javax.annotation.Nullable Currency currency) {
  ...
  public InvoiceOneOffCreateInputInvoice fees(@javax.annotation.Nonnull List<InvoiceOneOffCreateInputInvoiceFeesInner> fees) {
  ...
  @JsonProperty(JSON_PROPERTY_FEES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setFees(@javax.annotation.Nonnull List<InvoiceOneOffCreateInputInvoiceFeesInner> fees) {
    this.fees = fees;
  }

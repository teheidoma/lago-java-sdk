...
public class InvoiceUpdateInputInvoice {
  ...
  @javax.annotation.Nullable
  private List<InvoiceUpdateInputInvoiceMetadataInner> metadata = new ArrayList<>();

  public InvoiceUpdateInputInvoice() {
  }

  public InvoiceUpdateInputInvoice paymentStatus(@javax.annotation.Nullable PaymentStatusEnum paymentStatus) {
  ...
  public InvoiceUpdateInputInvoice metadata(@javax.annotation.Nullable List<InvoiceUpdateInputInvoiceMetadataInner> metadata) {
  ...
  @JsonProperty(JSON_PROPERTY_METADATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMetadata(@javax.annotation.Nullable List<InvoiceUpdateInputInvoiceMetadataInner> metadata) {
    this.metadata = metadata;
  }

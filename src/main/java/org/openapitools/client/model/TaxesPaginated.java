...
public class TaxesPaginated {
  ...
  public TaxesPaginated taxes(@javax.annotation.Nonnull List<TaxObject> taxes) {
  ...
  @JsonProperty(JSON_PROPERTY_TAXES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTaxes(@javax.annotation.Nonnull List<TaxObject> taxes) {
    this.taxes = taxes;
  }


  public TaxesPaginated meta(@javax.annotation.Nonnull PaginationMeta meta) {

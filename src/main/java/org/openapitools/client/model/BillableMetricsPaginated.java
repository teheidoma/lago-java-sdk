...
public class BillableMetricsPaginated {
  ...
  public BillableMetricsPaginated billableMetrics(@javax.annotation.Nonnull List<BillableMetricObject> billableMetrics) {
  ...
  @JsonProperty(JSON_PROPERTY_BILLABLE_METRICS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setBillableMetrics(@javax.annotation.Nonnull List<BillableMetricObject> billableMetrics) {
    this.billableMetrics = billableMetrics;
  }


  public BillableMetricsPaginated meta(@javax.annotation.Nonnull PaginationMeta meta) {

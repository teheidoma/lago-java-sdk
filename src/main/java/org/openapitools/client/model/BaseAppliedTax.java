...
public class BaseAppliedTax {
  ...
  public BaseAppliedTax lagoId(@javax.annotation.Nullable UUID lagoId) {
  ...
  public BaseAppliedTax lagoTaxId(@javax.annotation.Nullable UUID lagoTaxId) {
  ...
  public BaseAppliedTax taxName(@javax.annotation.Nullable String taxName) {
  ...
  public BaseAppliedTax taxCode(@javax.annotation.Nullable String taxCode) {
  ...
  public BaseAppliedTax taxRate(@javax.annotation.Nullable BigDecimal taxRate) {
  ...
  public BaseAppliedTax taxDescription(@javax.annotation.Nullable String taxDescription) {
  ...
  public BaseAppliedTax amountCents(@javax.annotation.Nullable Integer amountCents) {
  ...
  public BaseAppliedTax amountCurrency(@javax.annotation.Nullable Currency amountCurrency) {
  ...
  public BaseAppliedTax createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {

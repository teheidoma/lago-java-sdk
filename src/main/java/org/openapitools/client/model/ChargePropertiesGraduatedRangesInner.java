...
public class ChargePropertiesGraduatedRangesInner {
  ...
  public ChargePropertiesGraduatedRangesInner fromValue(@javax.annotation.Nonnull Integer fromValue) {
  ...
  public ChargePropertiesGraduatedRangesInner toValue(@javax.annotation.Nullable Integer toValue) {
  ...
  public ChargePropertiesGraduatedRangesInner flatAmount(@javax.annotation.Nonnull String flatAmount) {
  ...
  @JsonProperty(JSON_PROPERTY_FLAT_AMOUNT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setFlatAmount(@javax.annotation.Nonnull String flatAmount) {
    this.flatAmount = flatAmount;
  }


  public ChargePropertiesGraduatedRangesInner perUnitAmount(@javax.annotation.Nonnull String perUnitAmount) {

...
public class ApiErrorNotFound {
  ...
  public ApiErrorNotFound status(@javax.annotation.Nonnull Integer status) {
  ...
  public ApiErrorNotFound error(@javax.annotation.Nonnull String error) {
  ...
  public ApiErrorNotFound code(@javax.annotation.Nonnull String code) {

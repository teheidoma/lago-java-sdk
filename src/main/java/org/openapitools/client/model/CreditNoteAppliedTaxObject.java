...
public class CreditNoteAppliedTaxObject {
  ...
  public CreditNoteAppliedTaxObject lagoCreditNoteId(@javax.annotation.Nullable UUID lagoCreditNoteId) {
  ...
  @JsonProperty(JSON_PROPERTY_LAGO_CREDIT_NOTE_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLagoCreditNoteId(@javax.annotation.Nullable UUID lagoCreditNoteId) {
    this.lagoCreditNoteId = lagoCreditNoteId;
  }


  public CreditNoteAppliedTaxObject baseAmountCents(@javax.annotation.Nullable Integer baseAmountCents) {
  ...
  @JsonProperty(JSON_PROPERTY_BASE_AMOUNT_CENTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBaseAmountCents(@javax.annotation.Nullable Integer baseAmountCents) {
    this.baseAmountCents = baseAmountCents;
  }


  public CreditNoteAppliedTaxObject lagoId(@javax.annotation.Nullable UUID lagoId) {
  ...
  public CreditNoteAppliedTaxObject lagoTaxId(@javax.annotation.Nullable UUID lagoTaxId) {
  ...
  public CreditNoteAppliedTaxObject taxName(@javax.annotation.Nullable String taxName) {
  ...
  public CreditNoteAppliedTaxObject taxCode(@javax.annotation.Nullable String taxCode) {
  ...
  public CreditNoteAppliedTaxObject taxRate(@javax.annotation.Nullable BigDecimal taxRate) {
  ...
  public CreditNoteAppliedTaxObject taxDescription(@javax.annotation.Nullable String taxDescription) {
  ...
  public CreditNoteAppliedTaxObject amountCents(@javax.annotation.Nullable Integer amountCents) {
  ...
  public CreditNoteAppliedTaxObject amountCurrency(@javax.annotation.Nullable Currency amountCurrency) {
  ...
  public CreditNoteAppliedTaxObject createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {

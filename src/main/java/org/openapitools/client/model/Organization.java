...
public class Organization {
  ...
  public Organization organization(@javax.annotation.Nonnull OrganizationObject organization) {
  ...
  @JsonProperty(JSON_PROPERTY_ORGANIZATION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOrganization(@javax.annotation.Nonnull OrganizationObject organization) {
    this.organization = organization;
  }

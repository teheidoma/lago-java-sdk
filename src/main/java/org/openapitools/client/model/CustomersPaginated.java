...
public class CustomersPaginated {
  ...
  public CustomersPaginated customers(@javax.annotation.Nonnull List<CustomerObjectExtended> customers) {
  ...
  @JsonProperty(JSON_PROPERTY_CUSTOMERS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCustomers(@javax.annotation.Nonnull List<CustomerObjectExtended> customers) {
    this.customers = customers;
  }


  public CustomersPaginated meta(@javax.annotation.Nonnull PaginationMeta meta) {

...
@JsonPropertyOrder({
  ...
  CustomerBillingConfiguration.JSON_PROPERTY_PAYMENT_PROVIDER_CODE,
...
public class CustomerBillingConfiguration {
  ...
  public CustomerBillingConfiguration invoiceGracePeriod(@javax.annotation.Nullable Integer invoiceGracePeriod) {
  ...
  public CustomerBillingConfiguration paymentProvider(@javax.annotation.Nullable PaymentProviderEnum paymentProvider) {
  ...
  @JsonProperty(JSON_PROPERTY_PAYMENT_PROVIDER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPaymentProvider(@javax.annotation.Nullable PaymentProviderEnum paymentProvider) {
    this.paymentProvider = paymentProvider;
  }


  public CustomerBillingConfiguration paymentProviderCode(@javax.annotation.Nullable String paymentProviderCode) {
  ...
  public CustomerBillingConfiguration providerCustomerId(@javax.annotation.Nullable String providerCustomerId) {
  ...
  public CustomerBillingConfiguration sync(@javax.annotation.Nullable Boolean sync) {
  ...
  public CustomerBillingConfiguration syncWithProvider(@javax.annotation.Nullable Boolean syncWithProvider) {
  ...
  public CustomerBillingConfiguration documentLocale(@javax.annotation.Nullable String documentLocale) {
  ...
  public CustomerBillingConfiguration providerPaymentMethods(@javax.annotation.Nullable List<String> providerPaymentMethods) {
  ...
  public void setProviderPaymentMethods(@javax.annotation.Nullable List<String> providerPaymentMethods) {
    this.providerPaymentMethods = JsonNullable.<List<String>>of(providerPaymentMethods);
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.invoiceGracePeriod, customerBillingConfiguration.invoiceGracePeriod) &&
        ...
        Objects.equals(this.paymentProviderCode, customerBillingConfiguration.paymentProviderCode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(invoiceGracePeriod, paymentProvider, paymentProviderCode, providerCustomerId, sync, syncWithProvider, documentLocale, hashCodeNullable(providerPaymentMethods));
  }

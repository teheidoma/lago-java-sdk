...
public class AddOnObject {
  ...
  public AddOnObject lagoId(@javax.annotation.Nonnull UUID lagoId) {
  ...
  public AddOnObject name(@javax.annotation.Nonnull String name) {
  ...
  public AddOnObject invoiceDisplayName(@javax.annotation.Nullable String invoiceDisplayName) {
  ...
  public AddOnObject code(@javax.annotation.Nonnull String code) {
  ...
  public AddOnObject amountCents(@javax.annotation.Nonnull Integer amountCents) {
  ...
  public AddOnObject amountCurrency(@javax.annotation.Nonnull Currency amountCurrency) {
  ...
  public AddOnObject description(@javax.annotation.Nullable String description) {
  ...
  public AddOnObject createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public AddOnObject taxes(@javax.annotation.Nullable List<TaxObject> taxes) {

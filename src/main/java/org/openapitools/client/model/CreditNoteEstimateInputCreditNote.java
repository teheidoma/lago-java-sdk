...
public class CreditNoteEstimateInputCreditNote {
  ...
  public CreditNoteEstimateInputCreditNote invoiceId(@javax.annotation.Nonnull UUID invoiceId) {
  ...
  public CreditNoteEstimateInputCreditNote items(@javax.annotation.Nonnull List<CreditNoteCreateInputCreditNoteItemsInner> items) {
    
    this.items = items;
    return this;
  }

  public CreditNoteEstimateInputCreditNote addItemsItem(CreditNoteCreateInputCreditNoteItemsInner itemsItem) {
    if (this.items == null) {

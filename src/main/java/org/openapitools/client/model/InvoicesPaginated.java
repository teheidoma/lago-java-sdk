...
public class InvoicesPaginated {
  ...
  public InvoicesPaginated invoices(@javax.annotation.Nonnull List<InvoiceObject> invoices) {
  ...
  @JsonProperty(JSON_PROPERTY_INVOICES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setInvoices(@javax.annotation.Nonnull List<InvoiceObject> invoices) {
    this.invoices = invoices;
  }


  public InvoicesPaginated meta(@javax.annotation.Nonnull PaginationMeta meta) {

...
@JsonPropertyOrder({
  ...
  ChargeProperties.JSON_PROPERTY_GROUPED_BY,
...
public class ChargeProperties {
  ...
  private List<ChargePropertiesGraduatedRangesInner> graduatedRanges = new ArrayList<>();

  public static final String JSON_PROPERTY_GRADUATED_PERCENTAGE_RANGES = "graduated_percentage_ranges";
  @javax.annotation.Nullable
  private List<ChargePropertiesGraduatedPercentageRangesInner> graduatedPercentageRanges = new ArrayList<>();
  ...
  @javax.annotation.Nullable
  private List<String> groupedBy = new ArrayList<>();

  public static final String JSON_PROPERTY_VOLUME_RANGES = "volume_ranges";
  @javax.annotation.Nullable
  private List<ChargePropertiesVolumeRangesInner> volumeRanges = new ArrayList<>();

  public ChargeProperties() {
  }

  public ChargeProperties graduatedRanges(@javax.annotation.Nullable List<ChargePropertiesGraduatedRangesInner> graduatedRanges) {
  ...
  @JsonProperty(JSON_PROPERTY_GRADUATED_RANGES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGraduatedRanges(@javax.annotation.Nullable List<ChargePropertiesGraduatedRangesInner> graduatedRanges) {
    this.graduatedRanges = graduatedRanges;
  }


  public ChargeProperties graduatedPercentageRanges(@javax.annotation.Nullable List<ChargePropertiesGraduatedPercentageRangesInner> graduatedPercentageRanges) {
  ...
  @JsonProperty(JSON_PROPERTY_GRADUATED_PERCENTAGE_RANGES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGraduatedPercentageRanges(@javax.annotation.Nullable List<ChargePropertiesGraduatedPercentageRangesInner> graduatedPercentageRanges) {
    this.graduatedPercentageRanges = graduatedPercentageRanges;
  }


  public ChargeProperties amount(@javax.annotation.Nullable String amount) {
  ...
  public ChargeProperties freeUnits(@javax.annotation.Nullable Integer freeUnits) {
  ...
  @JsonProperty(JSON_PROPERTY_FREE_UNITS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFreeUnits(@javax.annotation.Nullable Integer freeUnits) {
    this.freeUnits = freeUnits;
  }


  public ChargeProperties packageSize(@javax.annotation.Nullable Integer packageSize) {
  ...
  @JsonProperty(JSON_PROPERTY_PACKAGE_SIZE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPackageSize(@javax.annotation.Nullable Integer packageSize) {
    this.packageSize = packageSize;
  }


  public ChargeProperties rate(@javax.annotation.Nullable String rate) {
  ...
  public ChargeProperties fixedAmount(@javax.annotation.Nullable String fixedAmount) {
  ...
  @JsonProperty(JSON_PROPERTY_FIXED_AMOUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFixedAmount(@javax.annotation.Nullable String fixedAmount) {
    this.fixedAmount = fixedAmount;
  }


  public ChargeProperties freeUnitsPerEvents(@javax.annotation.Nullable Integer freeUnitsPerEvents) {
  ...
  public void setFreeUnitsPerEvents(@javax.annotation.Nullable Integer freeUnitsPerEvents) {
    this.freeUnitsPerEvents = JsonNullable.<Integer>of(freeUnitsPerEvents);
  }


  public ChargeProperties freeUnitsPerTotalAggregation(@javax.annotation.Nullable String freeUnitsPerTotalAggregation) {
  ...
  public void setFreeUnitsPerTotalAggregation(@javax.annotation.Nullable String freeUnitsPerTotalAggregation) {
    this.freeUnitsPerTotalAggregation = JsonNullable.<String>of(freeUnitsPerTotalAggregation);
  }


  public ChargeProperties perTransactionMaxAmount(@javax.annotation.Nullable String perTransactionMaxAmount) {
  ...
  public void setPerTransactionMaxAmount(@javax.annotation.Nullable String perTransactionMaxAmount) {
    this.perTransactionMaxAmount = JsonNullable.<String>of(perTransactionMaxAmount);
  }


  public ChargeProperties perTransactionMinAmount(@javax.annotation.Nullable String perTransactionMinAmount) {
  ...
  public void setPerTransactionMinAmount(@javax.annotation.Nullable String perTransactionMinAmount) {
    this.perTransactionMinAmount = JsonNullable.<String>of(perTransactionMinAmount);
  }


  public ChargeProperties groupedBy(@javax.annotation.Nullable List<String> groupedBy) {
    
    this.groupedBy = groupedBy;
    return this;
  }

  public ChargeProperties addGroupedByItem(String groupedByItem) {
    if (this.groupedBy == null) {
      this.groupedBy = new ArrayList<>();
    }
    this.groupedBy.add(groupedByItem);
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_GROUPED_BY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGroupedBy(@javax.annotation.Nullable List<String> groupedBy) {
    this.groupedBy = groupedBy;
  }


  public ChargeProperties volumeRanges(@javax.annotation.Nullable List<ChargePropertiesVolumeRangesInner> volumeRanges) {
  ...
  @JsonProperty(JSON_PROPERTY_VOLUME_RANGES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVolumeRanges(@javax.annotation.Nullable List<ChargePropertiesVolumeRangesInner> volumeRanges) {
    this.volumeRanges = volumeRanges;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.graduatedRanges, chargeProperties.graduatedRanges) &&
        ...
        Objects.equals(this.groupedBy, chargeProperties.groupedBy) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(graduatedRanges, graduatedPercentageRanges, amount, freeUnits, packageSize, rate, fixedAmount, hashCodeNullable(freeUnitsPerEvents), hashCodeNullable(freeUnitsPerTotalAggregation), hashCodeNullable(perTransactionMaxAmount), hashCodeNullable(perTransactionMinAmount), groupedBy, volumeRanges);
  }

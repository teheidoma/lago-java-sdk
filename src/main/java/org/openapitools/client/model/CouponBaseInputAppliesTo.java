...
public class CouponBaseInputAppliesTo {
  ...
  public CouponBaseInputAppliesTo planCodes(@javax.annotation.Nullable List<String> planCodes) {
  ...
  public CouponBaseInputAppliesTo billableMetricCodes(@javax.annotation.Nullable List<String> billableMetricCodes) {

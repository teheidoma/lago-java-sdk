...
public class BillableMetricCreateInput {
  ...
  public BillableMetricCreateInput billableMetric(@javax.annotation.Nonnull BillableMetricBaseInput billableMetric) {
  ...
  @JsonProperty(JSON_PROPERTY_BILLABLE_METRIC)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setBillableMetric(@javax.annotation.Nonnull BillableMetricBaseInput billableMetric) {
    this.billableMetric = billableMetric;
  }

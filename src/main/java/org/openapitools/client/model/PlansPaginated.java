...
public class PlansPaginated {
  ...
  public PlansPaginated plans(@javax.annotation.Nonnull List<PlanObject> plans) {
  ...
  @JsonProperty(JSON_PROPERTY_PLANS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPlans(@javax.annotation.Nonnull List<PlanObject> plans) {
    this.plans = plans;
  }


  public PlansPaginated meta(@javax.annotation.Nonnull PaginationMeta meta) {

...
public class CreditNoteUpdateInputCreditNote {
  ...
  public CreditNoteUpdateInputCreditNote refundStatus(@javax.annotation.Nonnull RefundStatusEnum refundStatus) {
  ...
  @JsonProperty(JSON_PROPERTY_REFUND_STATUS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRefundStatus(@javax.annotation.Nonnull RefundStatusEnum refundStatus) {
    this.refundStatus = refundStatus;
  }

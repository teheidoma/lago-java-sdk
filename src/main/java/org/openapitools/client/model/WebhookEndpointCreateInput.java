...
public class WebhookEndpointCreateInput {
  ...
  public WebhookEndpointCreateInput webhookEndpoint(@javax.annotation.Nullable WebhookEndpointCreateInputWebhookEndpoint webhookEndpoint) {
  ...
  @JsonProperty(JSON_PROPERTY_WEBHOOK_ENDPOINT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setWebhookEndpoint(@javax.annotation.Nullable WebhookEndpointCreateInputWebhookEndpoint webhookEndpoint) {
    this.webhookEndpoint = webhookEndpoint;
  }

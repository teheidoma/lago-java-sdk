...
public class SubscriptionUpdateInputSubscription {
  ...
  public SubscriptionUpdateInputSubscription name(@javax.annotation.Nullable String name) {
  ...
  public SubscriptionUpdateInputSubscription endingAt(@javax.annotation.Nullable OffsetDateTime endingAt) {
  ...
  public SubscriptionUpdateInputSubscription subscriptionAt(@javax.annotation.Nullable OffsetDateTime subscriptionAt) {
  ...
  public SubscriptionUpdateInputSubscription planOverrides(@javax.annotation.Nullable PlanOverridesObject planOverrides) {

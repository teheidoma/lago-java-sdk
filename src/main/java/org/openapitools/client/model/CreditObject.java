...
public class CreditObject {
  ...
  public CreditObject lagoId(@javax.annotation.Nonnull UUID lagoId) {
  ...
  public CreditObject amountCents(@javax.annotation.Nonnull Integer amountCents) {
  ...
  public CreditObject amountCurrency(@javax.annotation.Nonnull Currency amountCurrency) {
  ...
  public CreditObject beforeTaxes(@javax.annotation.Nonnull Boolean beforeTaxes) {
  ...
  @JsonProperty(JSON_PROPERTY_BEFORE_TAXES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setBeforeTaxes(@javax.annotation.Nonnull Boolean beforeTaxes) {
    this.beforeTaxes = beforeTaxes;
  }


  public CreditObject item(@javax.annotation.Nonnull CreditObjectItem item) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEM)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setItem(@javax.annotation.Nonnull CreditObjectItem item) {
    this.item = item;
  }


  public CreditObject invoice(@javax.annotation.Nonnull CreditObjectInvoice invoice) {
  ...
  @JsonProperty(JSON_PROPERTY_INVOICE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setInvoice(@javax.annotation.Nonnull CreditObjectInvoice invoice) {
    this.invoice = invoice;
  }

...
public class SubscriptionUpdateInput {
  ...
  public SubscriptionUpdateInput status(@javax.annotation.Nullable StatusEnum status) {
  ...
  public SubscriptionUpdateInput subscription(@javax.annotation.Nonnull SubscriptionUpdateInputSubscription subscription) {
  ...
  @JsonProperty(JSON_PROPERTY_SUBSCRIPTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSubscription(@javax.annotation.Nonnull SubscriptionUpdateInputSubscription subscription) {
    this.subscription = subscription;
  }

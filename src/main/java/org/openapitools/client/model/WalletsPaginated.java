...
public class WalletsPaginated {
  ...
  public WalletsPaginated wallets(@javax.annotation.Nonnull List<WalletObject> wallets) {
  ...
  @JsonProperty(JSON_PROPERTY_WALLETS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setWallets(@javax.annotation.Nonnull List<WalletObject> wallets) {
    this.wallets = wallets;
  }


  public WalletsPaginated meta(@javax.annotation.Nonnull PaginationMeta meta) {

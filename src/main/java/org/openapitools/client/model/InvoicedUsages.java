...
public class InvoicedUsages {
  ...
  public InvoicedUsages invoicedUsages(@javax.annotation.Nonnull List<InvoicedUsageObject> invoicedUsages) {
  ...
  @JsonProperty(JSON_PROPERTY_INVOICED_USAGES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setInvoicedUsages(@javax.annotation.Nonnull List<InvoicedUsageObject> invoicedUsages) {
    this.invoicedUsages = invoicedUsages;
  }

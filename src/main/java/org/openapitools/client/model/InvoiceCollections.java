...
public class InvoiceCollections {
  ...
  public InvoiceCollections invoiceCollections(@javax.annotation.Nonnull List<InvoiceCollectionObject> invoiceCollections) {
  ...
  @JsonProperty(JSON_PROPERTY_INVOICE_COLLECTIONS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setInvoiceCollections(@javax.annotation.Nonnull List<InvoiceCollectionObject> invoiceCollections) {
    this.invoiceCollections = invoiceCollections;
  }

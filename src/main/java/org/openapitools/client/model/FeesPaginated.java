...
public class FeesPaginated {
  ...
  public FeesPaginated fees(@javax.annotation.Nonnull List<FeeObject> fees) {
  ...
  @JsonProperty(JSON_PROPERTY_FEES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setFees(@javax.annotation.Nonnull List<FeeObject> fees) {
    this.fees = fees;
  }


  public FeesPaginated meta(@javax.annotation.Nonnull PaginationMeta meta) {

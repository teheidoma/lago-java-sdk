...
public class InvoiceUpdateInput {
  ...
  public InvoiceUpdateInput invoice(@javax.annotation.Nonnull InvoiceUpdateInputInvoice invoice) {
  ...
  @JsonProperty(JSON_PROPERTY_INVOICE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setInvoice(@javax.annotation.Nonnull InvoiceUpdateInputInvoice invoice) {
    this.invoice = invoice;
  }

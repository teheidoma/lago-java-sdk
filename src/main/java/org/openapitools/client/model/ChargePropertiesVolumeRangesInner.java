...
public class ChargePropertiesVolumeRangesInner {
  ...
  public ChargePropertiesVolumeRangesInner fromValue(@javax.annotation.Nonnull Integer fromValue) {
  ...
  public ChargePropertiesVolumeRangesInner toValue(@javax.annotation.Nullable Integer toValue) {
  ...
  public ChargePropertiesVolumeRangesInner flatAmount(@javax.annotation.Nonnull String flatAmount) {
  ...
  public ChargePropertiesVolumeRangesInner perUnitAmount(@javax.annotation.Nonnull String perUnitAmount) {

...
public class AddOnsPaginated {
  ...
  public AddOnsPaginated addOns(@javax.annotation.Nonnull List<AddOnObject> addOns) {
  ...
  @JsonProperty(JSON_PROPERTY_ADD_ONS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAddOns(@javax.annotation.Nonnull List<AddOnObject> addOns) {
    this.addOns = addOns;
  }


  public AddOnsPaginated meta(@javax.annotation.Nonnull PaginationMeta meta) {

...
public class CreditNotes {
  ...
  public CreditNotes creditNotes(@javax.annotation.Nonnull List<CreditNoteObject> creditNotes) {
  ...
  @JsonProperty(JSON_PROPERTY_CREDIT_NOTES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreditNotes(@javax.annotation.Nonnull List<CreditNoteObject> creditNotes) {
    this.creditNotes = creditNotes;
  }

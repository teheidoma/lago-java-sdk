...
public class WalletCreateInput {
  ...
  public WalletCreateInput wallet(@javax.annotation.Nullable WalletCreateInputWallet wallet) {
  ...
  @JsonProperty(JSON_PROPERTY_WALLET)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setWallet(@javax.annotation.Nullable WalletCreateInputWallet wallet) {
    this.wallet = wallet;
  }

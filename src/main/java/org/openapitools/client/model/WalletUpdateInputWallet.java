...
@JsonPropertyOrder({
  ...
  WalletUpdateInputWallet.JSON_PROPERTY_INVOICE_REQUIRES_SUCCESSFUL_PAYMENT,
...
public class WalletUpdateInputWallet {
  ...
  @javax.annotation.Nullable
  private List<WalletUpdateInputWalletRecurringTransactionRulesInner> recurringTransactionRules = new ArrayList<>();

  public WalletUpdateInputWallet() {
  }

  public WalletUpdateInputWallet name(@javax.annotation.Nullable String name) {
  ...
  public WalletUpdateInputWallet expirationAt(@javax.annotation.Nullable OffsetDateTime expirationAt) {
  ...
  public WalletUpdateInputWallet invoiceRequiresSuccessfulPayment(@javax.annotation.Nullable Boolean invoiceRequiresSuccessfulPayment) {
  ...
  public WalletUpdateInputWallet recurringTransactionRules(@javax.annotation.Nullable List<WalletUpdateInputWalletRecurringTransactionRulesInner> recurringTransactionRules) {
  ...
  @JsonProperty(JSON_PROPERTY_RECURRING_TRANSACTION_RULES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRecurringTransactionRules(@javax.annotation.Nullable List<WalletUpdateInputWalletRecurringTransactionRulesInner> recurringTransactionRules) {
    this.recurringTransactionRules = recurringTransactionRules;
  }
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.name, walletUpdateInputWallet.name) &&
        ...
        Objects.equals(this.invoiceRequiresSuccessfulPayment, walletUpdateInputWallet.invoiceRequiresSuccessfulPayment) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(name), hashCodeNullable(expirationAt), invoiceRequiresSuccessfulPayment, recurringTransactionRules);
  }

...
public class EventInput {
  ...
  private EventInputObject event;

  public EventInput() {
  }

  public EventInput event(@javax.annotation.Nonnull EventInputObject event) {
  ...
  public EventInputObject getEvent() {
    return event;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EVENT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setEvent(@javax.annotation.Nonnull EventInputObject event) {
    this.event = event;
  }

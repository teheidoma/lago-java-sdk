...
public class GetCustomerPortalUrl200ResponseCustomer {
  ...
  public GetCustomerPortalUrl200ResponseCustomer portalUrl(@javax.annotation.Nonnull String portalUrl) {
  ...
  @JsonProperty(JSON_PROPERTY_PORTAL_URL)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPortalUrl(@javax.annotation.Nonnull String portalUrl) {
    this.portalUrl = portalUrl;
  }

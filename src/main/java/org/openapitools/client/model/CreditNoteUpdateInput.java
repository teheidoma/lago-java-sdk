...
public class CreditNoteUpdateInput {
  ...
  public CreditNoteUpdateInput creditNote(@javax.annotation.Nonnull CreditNoteUpdateInputCreditNote creditNote) {
  ...
  @JsonProperty(JSON_PROPERTY_CREDIT_NOTE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCreditNote(@javax.annotation.Nonnull CreditNoteUpdateInputCreditNote creditNote) {
    this.creditNote = creditNote;
  }

...
@JsonPropertyOrder({
  ...
  SubscriptionObject.JSON_PROPERTY_TRIAL_ENDED_AT,
  SubscriptionObject.JSON_PROPERTY_CURRENT_BILLING_PERIOD_STARTED_AT,
  SubscriptionObject.JSON_PROPERTY_CURRENT_BILLING_PERIOD_ENDING_AT
})
...
public class SubscriptionObject {
  ...
  private JsonNullable<OffsetDateTime> endingAt = JsonNullable.<OffsetDateTime>undefined();
  ...
  private JsonNullable<OffsetDateTime> trialEndedAt = JsonNullable.<OffsetDateTime>undefined();

  public static final String JSON_PROPERTY_CURRENT_BILLING_PERIOD_STARTED_AT = "current_billing_period_started_at";
  private JsonNullable<OffsetDateTime> currentBillingPeriodStartedAt = JsonNullable.<OffsetDateTime>undefined();

  public static final String JSON_PROPERTY_CURRENT_BILLING_PERIOD_ENDING_AT = "current_billing_period_ending_at";
  private JsonNullable<OffsetDateTime> currentBillingPeriodEndingAt = JsonNullable.<OffsetDateTime>undefined();

  public SubscriptionObject() {
  }

  public SubscriptionObject lagoId(@javax.annotation.Nonnull UUID lagoId) {
  ...
  public SubscriptionObject externalId(@javax.annotation.Nonnull String externalId) {
  ...
  public SubscriptionObject lagoCustomerId(@javax.annotation.Nonnull UUID lagoCustomerId) {
  ...
  public SubscriptionObject externalCustomerId(@javax.annotation.Nonnull String externalCustomerId) {
  ...
  public SubscriptionObject billingTime(@javax.annotation.Nonnull BillingTimeEnum billingTime) {
  ...
  public SubscriptionObject name(@javax.annotation.Nullable String name) {
  ...
  public SubscriptionObject planCode(@javax.annotation.Nonnull String planCode) {
  ...
  public SubscriptionObject status(@javax.annotation.Nonnull StatusEnum status) {
  ...
  public SubscriptionObject startedAt(@javax.annotation.Nullable OffsetDateTime startedAt) {
  ...
  public SubscriptionObject endingAt(@javax.annotation.Nullable OffsetDateTime endingAt) {
    this.endingAt = JsonNullable.<OffsetDateTime>of(endingAt);
  ...
  public JsonNullable<OffsetDateTime> getEndingAt_JsonNullable() {
    return endingAt;
  }
  
  @JsonProperty(JSON_PROPERTY_ENDING_AT)
  public void setEndingAt_JsonNullable(JsonNullable<OffsetDateTime> endingAt) {
  ...
  public SubscriptionObject subscriptionAt(@javax.annotation.Nonnull OffsetDateTime subscriptionAt) {
  ...
  public SubscriptionObject terminatedAt(@javax.annotation.Nullable OffsetDateTime terminatedAt) {
  ...
  public SubscriptionObject previousPlanCode(@javax.annotation.Nullable String previousPlanCode) {
  ...
  public SubscriptionObject nextPlanCode(@javax.annotation.Nullable String nextPlanCode) {
  ...
  public SubscriptionObject downgradePlanDate(@javax.annotation.Nullable LocalDate downgradePlanDate) {
  ...
  public SubscriptionObject trialEndedAt(@javax.annotation.Nullable OffsetDateTime trialEndedAt) {
    this.trialEndedAt = JsonNullable.<OffsetDateTime>of(trialEndedAt);
  ...
  public OffsetDateTime getTrialEndedAt() {
        return trialEndedAt.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_TRIAL_ENDED_AT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<OffsetDateTime> getTrialEndedAt_JsonNullable() {
    return trialEndedAt;
  }
  
  @JsonProperty(JSON_PROPERTY_TRIAL_ENDED_AT)
  public void setTrialEndedAt_JsonNullable(JsonNullable<OffsetDateTime> trialEndedAt) {
  ...
  public SubscriptionObject currentBillingPeriodStartedAt(@javax.annotation.Nullable OffsetDateTime currentBillingPeriodStartedAt) {
    this.currentBillingPeriodStartedAt = JsonNullable.<OffsetDateTime>of(currentBillingPeriodStartedAt);
  ...
  public OffsetDateTime getCurrentBillingPeriodStartedAt() {
        return currentBillingPeriodStartedAt.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_CURRENT_BILLING_PERIOD_STARTED_AT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<OffsetDateTime> getCurrentBillingPeriodStartedAt_JsonNullable() {
    return currentBillingPeriodStartedAt;
  }
  
  @JsonProperty(JSON_PROPERTY_CURRENT_BILLING_PERIOD_STARTED_AT)
  public void setCurrentBillingPeriodStartedAt_JsonNullable(JsonNullable<OffsetDateTime> currentBillingPeriodStartedAt) {
  ...
  public SubscriptionObject currentBillingPeriodEndingAt(@javax.annotation.Nullable OffsetDateTime currentBillingPeriodEndingAt) {
    this.currentBillingPeriodEndingAt = JsonNullable.<OffsetDateTime>of(currentBillingPeriodEndingAt);
  ...
  public OffsetDateTime getCurrentBillingPeriodEndingAt() {
        return currentBillingPeriodEndingAt.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_CURRENT_BILLING_PERIOD_ENDING_AT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<OffsetDateTime> getCurrentBillingPeriodEndingAt_JsonNullable() {
    return currentBillingPeriodEndingAt;
  }
  
  @JsonProperty(JSON_PROPERTY_CURRENT_BILLING_PERIOD_ENDING_AT)
  public void setCurrentBillingPeriodEndingAt_JsonNullable(JsonNullable<OffsetDateTime> currentBillingPeriodEndingAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.lagoId, subscriptionObject.lagoId) &&
        ...
        equalsNullable(this.endingAt, subscriptionObject.endingAt) &&
        ...
        equalsNullable(this.trialEndedAt, subscriptionObject.trialEndedAt) &&
        equalsNullable(this.currentBillingPeriodStartedAt, subscriptionObject.currentBillingPeriodStartedAt) &&
        equalsNullable(this.currentBillingPeriodEndingAt, subscriptionObject.currentBillingPeriodEndingAt);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(lagoId, externalId, lagoCustomerId, externalCustomerId, billingTime, hashCodeNullable(name), planCode, status, createdAt, hashCodeNullable(canceledAt), hashCodeNullable(startedAt), hashCodeNullable(endingAt), subscriptionAt, hashCodeNullable(terminatedAt), hashCodeNullable(previousPlanCode), hashCodeNullable(nextPlanCode), hashCodeNullable(downgradePlanDate), hashCodeNullable(trialEndedAt), hashCodeNullable(currentBillingPeriodStartedAt), hashCodeNullable(currentBillingPeriodEndingAt));
  }

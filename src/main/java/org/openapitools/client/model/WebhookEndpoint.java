...
public class WebhookEndpoint {
  ...
  public WebhookEndpoint webhookEndpoint(@javax.annotation.Nonnull WebhookEndpointObject webhookEndpoint) {
  ...
  @JsonProperty(JSON_PROPERTY_WEBHOOK_ENDPOINT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setWebhookEndpoint(@javax.annotation.Nonnull WebhookEndpointObject webhookEndpoint) {
    this.webhookEndpoint = webhookEndpoint;
  }

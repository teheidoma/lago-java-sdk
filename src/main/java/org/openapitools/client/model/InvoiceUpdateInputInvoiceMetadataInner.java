...
public class InvoiceUpdateInputInvoiceMetadataInner {
  ...
  public InvoiceUpdateInputInvoiceMetadataInner id(@javax.annotation.Nullable UUID id) {
  ...
  public InvoiceUpdateInputInvoiceMetadataInner key(@javax.annotation.Nullable String key) {
  ...
  public InvoiceUpdateInputInvoiceMetadataInner value(@javax.annotation.Nullable String value) {

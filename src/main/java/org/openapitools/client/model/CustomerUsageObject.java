...
public class CustomerUsageObject {
  ...
  public CustomerUsageObject fromDatetime(@javax.annotation.Nonnull OffsetDateTime fromDatetime) {
  ...
  public CustomerUsageObject toDatetime(@javax.annotation.Nonnull OffsetDateTime toDatetime) {
  ...
  public CustomerUsageObject issuingDate(@javax.annotation.Nonnull LocalDate issuingDate) {
  ...
  public CustomerUsageObject lagoInvoiceId(@javax.annotation.Nullable UUID lagoInvoiceId) {
  ...
  public CustomerUsageObject currency(@javax.annotation.Nullable Currency currency) {
  ...
  public CustomerUsageObject amountCents(@javax.annotation.Nonnull Integer amountCents) {
  ...
  public CustomerUsageObject taxesAmountCents(@javax.annotation.Nonnull Integer taxesAmountCents) {
  ...
  public CustomerUsageObject totalAmountCents(@javax.annotation.Nonnull Integer totalAmountCents) {
  ...
  public CustomerUsageObject chargesUsage(@javax.annotation.Nonnull List<CustomerChargeUsageObject> chargesUsage) {
  ...
  @JsonProperty(JSON_PROPERTY_CHARGES_USAGE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setChargesUsage(@javax.annotation.Nonnull List<CustomerChargeUsageObject> chargesUsage) {
    this.chargesUsage = chargesUsage;
  }

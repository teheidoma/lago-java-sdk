...
public class WebhookEndpointObject {
  ...
  public WebhookEndpointObject lagoId(@javax.annotation.Nonnull UUID lagoId) {
  ...
  public WebhookEndpointObject lagoOrganizationId(@javax.annotation.Nonnull UUID lagoOrganizationId) {
  ...
  @JsonProperty(JSON_PROPERTY_LAGO_ORGANIZATION_ID)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setLagoOrganizationId(@javax.annotation.Nonnull UUID lagoOrganizationId) {
    this.lagoOrganizationId = lagoOrganizationId;
  }


  public WebhookEndpointObject webhookUrl(@javax.annotation.Nonnull String webhookUrl) {
  ...
  public WebhookEndpointObject signatureAlgo(@javax.annotation.Nullable SignatureAlgoEnum signatureAlgo) {
  ...
  @JsonProperty(JSON_PROPERTY_SIGNATURE_ALGO)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSignatureAlgo(@javax.annotation.Nullable SignatureAlgoEnum signatureAlgo) {
    this.signatureAlgo = signatureAlgo;
  }


  public WebhookEndpointObject createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {

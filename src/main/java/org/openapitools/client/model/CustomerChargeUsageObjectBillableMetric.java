...
public class CustomerChargeUsageObjectBillableMetric {
  ...
  public CustomerChargeUsageObjectBillableMetric lagoId(@javax.annotation.Nonnull UUID lagoId) {
  ...
  public CustomerChargeUsageObjectBillableMetric name(@javax.annotation.Nonnull String name) {
  ...
  public CustomerChargeUsageObjectBillableMetric code(@javax.annotation.Nonnull String code) {
  ...
  public CustomerChargeUsageObjectBillableMetric aggregationType(@javax.annotation.Nonnull AggregationTypeEnum aggregationType) {

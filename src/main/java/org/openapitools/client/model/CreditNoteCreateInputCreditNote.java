...
public class CreditNoteCreateInputCreditNote {
  ...
  public CreditNoteCreateInputCreditNote invoiceId(@javax.annotation.Nonnull UUID invoiceId) {
  ...
  public CreditNoteCreateInputCreditNote reason(@javax.annotation.Nullable ReasonEnum reason) {
  ...
  public CreditNoteCreateInputCreditNote description(@javax.annotation.Nullable String description) {
  ...
  public CreditNoteCreateInputCreditNote creditAmountCents(@javax.annotation.Nullable Integer creditAmountCents) {
  ...
  public void setCreditAmountCents(@javax.annotation.Nullable Integer creditAmountCents) {
    this.creditAmountCents = JsonNullable.<Integer>of(creditAmountCents);
  }


  public CreditNoteCreateInputCreditNote refundAmountCents(@javax.annotation.Nullable Integer refundAmountCents) {
  ...
  public void setRefundAmountCents(@javax.annotation.Nullable Integer refundAmountCents) {
    this.refundAmountCents = JsonNullable.<Integer>of(refundAmountCents);
  }


  public CreditNoteCreateInputCreditNote items(@javax.annotation.Nonnull List<CreditNoteCreateInputCreditNoteItemsInner> items) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setItems(@javax.annotation.Nonnull List<CreditNoteCreateInputCreditNoteItemsInner> items) {
    this.items = items;
  }

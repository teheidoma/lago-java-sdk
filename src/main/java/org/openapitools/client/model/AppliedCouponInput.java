...
public class AppliedCouponInput {
  ...
  public AppliedCouponInput appliedCoupon(@javax.annotation.Nonnull AppliedCouponInputAppliedCoupon appliedCoupon) {
  ...
  @JsonProperty(JSON_PROPERTY_APPLIED_COUPON)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAppliedCoupon(@javax.annotation.Nonnull AppliedCouponInputAppliedCoupon appliedCoupon) {
    this.appliedCoupon = appliedCoupon;
  }

 ...
 */
@JsonPropertyOrder({
  WalletCreateInputWalletRecurringTransactionRulesInner.JSON_PROPERTY_PAID_CREDITS,
  WalletCreateInputWalletRecurringTransactionRulesInner.JSON_PROPERTY_GRANTED_CREDITS,
  WalletCreateInputWalletRecurringTransactionRulesInner.JSON_PROPERTY_METHOD,
  WalletCreateInputWalletRecurringTransactionRulesInner.JSON_PROPERTY_TRIGGER,
  WalletCreateInputWalletRecurringTransactionRulesInner.JSON_PROPERTY_INTERVAL,
  WalletCreateInputWalletRecurringTransactionRulesInner.JSON_PROPERTY_STARTED_AT,
  WalletCreateInputWalletRecurringTransactionRulesInner.JSON_PROPERTY_EXPIRATION_AT,
  WalletCreateInputWalletRecurringTransactionRulesInner.JSON_PROPERTY_THRESHOLD_CREDITS,
  WalletCreateInputWalletRecurringTransactionRulesInner.JSON_PROPERTY_TARGET_ONGOING_BALANCE,
  WalletCreateInputWalletRecurringTransactionRulesInner.JSON_PROPERTY_INVOICE_REQUIRES_SUCCESSFUL_PAYMENT,
  WalletCreateInputWalletRecurringTransactionRulesInner.JSON_PROPERTY_TRANSACTION_METADATA
})
...
public class WalletCreateInputWalletRecurringTransactionRulesInner {
  ...
  public WalletCreateInputWalletRecurringTransactionRulesInner paidCredits(@javax.annotation.Nullable String paidCredits) {
  ...
  public WalletCreateInputWalletRecurringTransactionRulesInner grantedCredits(@javax.annotation.Nullable String grantedCredits) {
  ...
  public WalletCreateInputWalletRecurringTransactionRulesInner method(@javax.annotation.Nullable MethodEnum method) {
  ...
  public WalletCreateInputWalletRecurringTransactionRulesInner trigger(@javax.annotation.Nonnull TriggerEnum trigger) {
  ...
  public WalletCreateInputWalletRecurringTransactionRulesInner interval(@javax.annotation.Nullable IntervalEnum interval) {
  ...
  public WalletCreateInputWalletRecurringTransactionRulesInner startedAt(@javax.annotation.Nullable OffsetDateTime startedAt) {
  ...
  public WalletCreateInputWalletRecurringTransactionRulesInner expirationAt(@javax.annotation.Nullable OffsetDateTime expirationAt) {
  ...
  public WalletCreateInputWalletRecurringTransactionRulesInner thresholdCredits(@javax.annotation.Nullable String thresholdCredits) {
  ...
  public WalletCreateInputWalletRecurringTransactionRulesInner targetOngoingBalance(@javax.annotation.Nullable String targetOngoingBalance) {
  ...
  public WalletCreateInputWalletRecurringTransactionRulesInner invoiceRequiresSuccessfulPayment(@javax.annotation.Nullable Boolean invoiceRequiresSuccessfulPayment) {
  ...
  public WalletCreateInputWalletRecurringTransactionRulesInner transactionMetadata(@javax.annotation.Nullable List<WalletRecurringTransactionRuleTransactionMetadataInner> transactionMetadata) {
    
    this.transactionMetadata = transactionMetadata;
    return this;
  }

  public WalletCreateInputWalletRecurringTransactionRulesInner addTransactionMetadataItem(WalletRecurringTransactionRuleTransactionMetadataInner transactionMetadataItem) {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.paidCredits, walletCreateInputWalletRecurringTransactionRulesInner.paidCredits) &&
        equalsNullable(this.grantedCredits, walletCreateInputWalletRecurringTransactionRulesInner.grantedCredits) &&
        Objects.equals(this.method, walletCreateInputWalletRecurringTransactionRulesInner.method) &&
        Objects.equals(this.trigger, walletCreateInputWalletRecurringTransactionRulesInner.trigger) &&
        Objects.equals(this.interval, walletCreateInputWalletRecurringTransactionRulesInner.interval) &&
        Objects.equals(this.startedAt, walletCreateInputWalletRecurringTransactionRulesInner.startedAt) &&
        equalsNullable(this.expirationAt, walletCreateInputWalletRecurringTransactionRulesInner.expirationAt) &&
        Objects.equals(this.thresholdCredits, walletCreateInputWalletRecurringTransactionRulesInner.thresholdCredits) &&
        Objects.equals(this.targetOngoingBalance, walletCreateInputWalletRecurringTransactionRulesInner.targetOngoingBalance) &&
        Objects.equals(this.invoiceRequiresSuccessfulPayment, walletCreateInputWalletRecurringTransactionRulesInner.invoiceRequiresSuccessfulPayment) &&
        Objects.equals(this.transactionMetadata, walletCreateInputWalletRecurringTransactionRulesInner.transactionMetadata);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(paidCredits), hashCodeNullable(grantedCredits), method, trigger, interval, startedAt, hashCodeNullable(expirationAt), thresholdCredits, targetOngoingBalance, invoiceRequiresSuccessfulPayment, transactionMetadata);
  }

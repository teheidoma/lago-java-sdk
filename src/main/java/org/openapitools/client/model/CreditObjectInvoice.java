...
public class CreditObjectInvoice {
  ...
  public CreditObjectInvoice lagoId(@javax.annotation.Nonnull UUID lagoId) {
  ...
  public CreditObjectInvoice paymentStatus(@javax.annotation.Nonnull PaymentStatusEnum paymentStatus) {

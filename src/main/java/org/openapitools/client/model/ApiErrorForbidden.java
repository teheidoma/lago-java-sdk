...
public class ApiErrorForbidden {
  ...
  public ApiErrorForbidden status(@javax.annotation.Nonnull Integer status) {
  ...
  public ApiErrorForbidden error(@javax.annotation.Nonnull String error) {
  ...
  public ApiErrorForbidden code(@javax.annotation.Nonnull String code) {

...
public class CustomerCreateInputCustomerMetadataInner {
  ...
  public CustomerCreateInputCustomerMetadataInner id(@javax.annotation.Nullable UUID id) {
  ...
  public CustomerCreateInputCustomerMetadataInner key(@javax.annotation.Nonnull String key) {
  ...
  public CustomerCreateInputCustomerMetadataInner value(@javax.annotation.Nonnull String value) {
  ...
  public CustomerCreateInputCustomerMetadataInner displayInInvoice(@javax.annotation.Nonnull Boolean displayInInvoice) {
  ...
  @JsonProperty(JSON_PROPERTY_DISPLAY_IN_INVOICE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setDisplayInInvoice(@javax.annotation.Nonnull Boolean displayInInvoice) {
    this.displayInInvoice = displayInInvoice;
  }

...
public class GrossRevenues {
  ...
  public GrossRevenues grossRevenues(@javax.annotation.Nonnull List<GrossRevenueObject> grossRevenues) {
  ...
  @JsonProperty(JSON_PROPERTY_GROSS_REVENUES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setGrossRevenues(@javax.annotation.Nonnull List<GrossRevenueObject> grossRevenues) {
    this.grossRevenues = grossRevenues;
  }
